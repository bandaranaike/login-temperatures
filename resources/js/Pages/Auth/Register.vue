<template>
    ...
    <jet-authentication-card>
        ...
        <form @submit.prevent="submit">
            ...
            <div>
                <jet-label for="city1" value="city1"/>
                <select id="city1" class="mt-1 block w-full" v-model="form.city1" required autofocus
                        autocomplete="city1">
            ...
            <div>
                <jet-label for="city2" value="city2"/>
                <select id="city2" class="mt-1 block w-full" v-model="form.city2" required autofocus
                        autocomplete="city2">
                    <option v-for="city in cities" :value="city.id">{{ city.name }}</option>
                </select>
            </div>
